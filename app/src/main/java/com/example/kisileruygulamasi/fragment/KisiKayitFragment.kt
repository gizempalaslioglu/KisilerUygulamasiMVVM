...
class KisiKayitFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //oluşturduğum variableları burada belirtmem gerekiyor
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Fragment içinde viewModel bağlıyorum
        val temp:KisiKayitFragmentViewModel by viewModels()
        viewModel=temp
    }

    fun buttonKaydet(kisi_ad:String,kisi_tel:String){ //buton bastığımda kişi adı ve kişi teli verecek
